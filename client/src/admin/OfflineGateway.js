...
export default function OfflineGateway() {
  ...
  const fetchSettings = async () => {
    try {
      const res = await axios.get('https://qxtrand.onrender.com/api/api/admin/trading-income-settings');
  ...
  const handleSave = async (e) => {
    ...
    setMsg('');
    try {
      const res = await axios.post('https://qxtrand.onrender.com/api/api/admin/deposit-settings', {
  ...
  const handleQrUpload = async (e) => {
    ...
    try {
      const res = await axios.post('https://qxtrand.onrender.com/api/api/admin/upload-qr', formData, {
