...
const UserDetail = () => {
  ...
  const handleBanUser = () => {
    if(window.confirm('Are you sure you want to ban this user?')) {
      axios.post(`https://qxtrand.onrender.com/api/admin/ban-user`, { userId: id })
        .then(res => {
          if(res.data.success) {
  ...
  const handleDeleteUser = () => {
    if(window.confirm('Are you sure you want to delete this user?')) {
      axios.delete(`https://qxtrand.onrender.com/api/admin/delete-user/${id}`)
        .then(res => {
          if(res.data.success) {
  ...
  const handleLoginAsUser = () => {
    ...
    axios.post(`https://qxtrand.onrender.com/api/admin/login-as-user`, { userId: id })
      .then(res => {
